...
function browserRollup() {
  return rollup({
    ...
    bundle.write({
      file: "browser/capnp-js-trans-concat.js",
      format: "umd",
      name: "capnpJsTransConcat",
      sourcemap: true,
      globals: {
...
function browserUglify() {
  return new Promise((resolve, reject) => {
    fs.readFile("browser/capnp-js-trans-concat.js.map", (err, map) => {
      if (err) {
        reject(err);
      } else {
        const ugly = gulp.src("browser/capnp-js-trans-concat.js")
          .pipe(uglify({
            sourceMap: {
              content: map.toString(),
              url: "capnp-js-trans-concat.js.map",
            },
          }))
